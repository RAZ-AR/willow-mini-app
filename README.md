...
- **ADMIN_CHANNEL_ID**: Обновлено на новую группу `-2908297535` - нужно добавить бота @willow_L_bot
...
#### 2. Добавьте бота в новую админ-группу
1. **Откройте группу**: https://web.telegram.org/k/#-2908297535
2. **Добавьте @willow_L_bot в группу**
3. **Дайте права администратора** (или минимум на отправку сообщений)
4. **Установите ADMIN_CHANNEL_ID=-2908297535 в Koyeb**
5. **Отправьте тестовое сообщение** для проверки

#### 3. Обновите переменную в Koyeb
```bash
# Зайдите в панель Koyeb → Settings → Environment Variables
ADMIN_CHANNEL_ID=-2908297535
