...
- **ADMIN_CHANNEL_ID**: Обновлено на новую группу `-1002908297535` - бот добавлен ✅
...
1. **Группа**: https://web.telegram.org/k/#-2908297535 ✅
2. **Бот @willow_L_bot добавлен** ✅
3. **Права администратора даны** ✅
4. **Правильный ID найден**: `-1002908297535` ✅

#### 3. Обновите переменную в Koyeb
```bash
# Зайдите в панель Koyeb → Settings → Environment Variables
ADMIN_CHANNEL_ID=-1002908297535
